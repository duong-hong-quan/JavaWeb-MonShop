                    ...
                    <div style="display: flex; ">
                        ...
                        <div class="search">
                            <form action="searchAccountAction" method="POST">
                                <input class="search-input" type="text" placeholder="Search by name" name="txtSearch"
                                       value="${txtSearch}"/>
                            ...
                            <form action="updateAccountByAdminAction" method="POST">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input class="input-edit-user" type="text" name="password"
                                               value="${dto.password}"/>
                                    </td>


                                    <td class="text-center">
                                        <input class="input-edit-user" type="text" name="address"
                                               value="${dto.address}"/>
                                    </td>
                                    <td class="text-center">
                                        <input class="input-edit-user" type="text" name="phonenum"
                                               value="${dto.phonenum}"/>
                                    </td>
